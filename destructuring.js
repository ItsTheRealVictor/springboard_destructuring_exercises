...
// this won't work without semicolons, took me a long time to figure that out. I edited the setting in my autoformatter so it doesn't happen again.
const arr = [1, 2];
...
*/
const example5 = ["Tom", "Margaret", "Allison", "David", "Pierre"];
...
console.log(raceResults(example5))
